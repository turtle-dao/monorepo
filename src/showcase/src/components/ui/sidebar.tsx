...
const SidebarContext = React.createContext<SidebarContextT | null>(null);

function useSidebar(): SidebarContextT {
...
} & { ref?: React.RefObject<HTMLDivElement> }): React.ReactElement {
